        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 8, marginTop: 8 }}>
          ...
          {doc.agentSessionId && (
            <div style={{ fontSize: 11, color: 'var(--color-text-tertiary)', display: 'flex', alignItems: 'center', gap: 4 }}>
              {t('documents.generatedByAgentSession', { id: doc.agentSessionId })}
            </div>
          )}
        </div>
      )}
    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', background: 'var(--color-bg)' }}>
      ...
      <div style={{
        ...
        <span style={{
          ...
          {saveState === 'saved' ? t('documents.saved') : saveState === 'saving' ? t('documents.saving') : t('documents.unsaved')}
        </span>
        ...
        {doc.contentType === 'markdown' && (
          <button
            ...
            title={isSourceMode ? t('documents.preview') : t('documents.source')}
            style={{
          ...
          >
            ...
            {isSourceMode ? t('documents.preview') : t('documents.source')}
          </button>
        )}
          ...
          {showMoreMenu && (
            <>
              ...
              <div style={{
                ...
                {[
                  { icon: Copy, label: t('documents.duplicate'), action: () => {} },
                  { icon: Archive, label: t('documents.archive'), action: () => {} },
                  { icon: Trash2, label: t('documents.delete'), action: () => {}, danger: true },
      ...
      {viewingVersion && (
        <div style={{
          ...
          <span style={{ fontSize: 12, color: 'var(--color-warning)', fontWeight: 500 }}>
            {t('documents.viewingVersion', { version: viewingVersion.version })}
          </span>
          <span style={{ fontSize: 11, color: 'var(--color-text-tertiary)' }}>
            {t('documents.byAuthor', { author: viewingVersion.updatedBy })}
          </span>
          <div style={{ flex: 1 }} />
          <button
          ...
          >
            <RotateCcw size={11} />
            {t('documents.restoreThisVersion')}
          </button>
        </div>
      )}
